    ...
    <div className={`text-on-surface bg-background font-body min-h-screen ${className}`}>
      ...
      <main className="ml-64 min-h-screen pb-12">
        ...
        <div className="p-8 space-y-10 max-w-7xl mx-auto">
          ...
          {/* Row 2: Smarter Swaps Feed */}
          <section>
            <div className="flex justify-between items-end mb-6">
              <div>
                <h2 className="font-headline text-3xl">Smarter Swaps</h2>
                <p className="text-on-surface-variant text-sm mt-1">Personalized shifts based on your morning labs.</p>
              </div>
            ...
            <div className="lg:col-span-7 bg-surface-container-lowest p-8 rounded-3xl shadow-[0_8px_24px_rgba(28,20,9,0.03)] border-t-4 border-secondary">
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <p className="text-sm text-on-surface-variant">Simulated insulin and glucose response for the next 4 hours.</p>
                </div>
              ...
              <div className="mt-12 flex gap-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Projected Glucose</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[#9ca3af]"></span>
                  <span className="text-xs font-bold text-on-surface-variant uppercase tracking-wider">Previous Trend</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container p-8 rounded-[2rem] flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-on-surface-variant max-w-sm mt-2">Log your meal in seconds using your preferred method for instant feedback.</p>
            </div>
            ...
            <div className="absolute right-40 top-10 w-20 h-20 bg-secondary/5 rounded-full blur-xl"></div>
          </div>
        </div>
